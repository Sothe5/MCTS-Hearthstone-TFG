...
namespace SabberStoneCoreAi
{
	internal class Program
	{
		...
		private static void Main(string[] args)
		{
			...
			/*
			 * Double.Parse(args[0]), Int32.Parse(args[1]), args[2], Double.Parse(args[3]), args[4], Int32.Parse(args[5]),
			   Int32.Parse(args[6]),args[7], args[8], args[9], args[10], args[11], args[12], args[13], args[14], args[15],
			   args[16], args[17], args[18], args[19], args[20], args[21], args[22], args[23], args[24], args[25], args[26],
		       args[27]
			 */
			AbstractAgent player1 = new AlvaroAgent(2,10000,"MaxVictories",1,"UCB1Heuristic",5, Int32.MaxValue, "GreedyPolicy", 0.7, "0.569460712743","0.958111820041","0.0689492467097","0.0","0.843573987219",
				"0.700225423688","0.907680353441","0.0","0.993682660717","1.0","0.640753949511","0.992872512338","0.92870036875","0.168100484322","0.870080107454",
													"0.0","0.42897762808","1.0","0.0","0.583884736646","0.0");
